...
class SampleTweets{
  ...
  ImageTweet imageTweet5 = new ImageTweet(new User("DWade", "Dwyane Wade"),new DateTime(11,4,2017),"I try not to take anything for granted. 14 years later the love is still there for that number 3 jersey. Thank you fans!!!",   "851959081036378112", "https://pbs.twimg.com/media/C9LEQ-eW0AIY0Ig.jpg", 3072,79878);
   ...
   QuoteTweet quoteTweet5 = new QuoteTweet(bunny, new DateTime(23,4,2008),"Q: How do you know carrots are good for your eyes? A: Because you never see rabbits wearing glasses! Read more at: http://www.ducksters.com/jokes/rabbit.php This text is Copyright (c) Ducksters.","8819471987600855039-rt-rt",quoteTweet4,2);
